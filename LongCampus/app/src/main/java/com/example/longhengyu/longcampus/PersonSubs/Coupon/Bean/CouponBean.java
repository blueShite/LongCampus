package com.example.longhengyu.longcampus.PersonSubs.Coupon.Bean;
...
public class CouponBean {
    ...
    public void setlCouponType(String lCouponType) {
        this.lCouponType = lCouponType;
    }
